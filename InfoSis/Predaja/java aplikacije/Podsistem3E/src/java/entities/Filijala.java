...
public class Filijala implements Serializable {
    ...
    @JoinColumn(name = "MestoFilijale", referencedColumnName = "idMesto")
    @ManyToOne(optional = false)
    private Mesto mestoFilijale;
    ...
    public Mesto getMestoFilijale() {
        return mestoFilijale;
    }

    public void setMestoFilijale(Mesto mestoFilijale) {
        this.mestoFilijale = mestoFilijale;
    }
