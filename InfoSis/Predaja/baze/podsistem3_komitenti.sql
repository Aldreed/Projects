...
CREATE TABLE `komitenti` (
  `idKomitenti` int NOT NULL AUTO_INCREMENT,
  `Naziv` varchar(200) NOT NULL,
  `Adresa` varchar(200) NOT NULL,
  `Sediste` int NOT NULL,
  PRIMARY KEY (`idKomitenti`),
  KEY `Sediste_idx` (`Sediste`),
  CONSTRAINT `Sediste` FOREIGN KEY (`Sediste`) REFERENCES `mesto` (`idMesto`) ON UPDATE CASCADE
...
INSERT INTO `komitenti` VALUES (24,'Komitent1','Adresa1',22),(25,'Komitent2','Adresa2',23);
...
-- Dump completed on 2022-07-06 14:59:22
