...
CREATE TABLE `filijala` (
  ...
  `MestoFilijale` int NOT NULL,
  PRIMARY KEY (`idFilijala`),
  KEY `MestoFilijale_idx` (`MestoFilijale`),
  CONSTRAINT `MestoFilijale` FOREIGN KEY (`MestoFilijale`) REFERENCES `mesto` (`idMesto`) ON UPDATE CASCADE
...
INSERT INTO `filijala` VALUES (4,'Filijala1','Adresa1',22);
...
-- Dump completed on 2022-07-06 14:59:21
